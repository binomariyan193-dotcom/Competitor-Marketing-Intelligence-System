-- COMPETITOR MARKETING INTELLIGENCE SYSTEM SCHEMA (SUPABASE POSTGRESQL)
...
VALUES
  ('p1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Pro Tier', 199.00, 'USD', 'monthly', '["Unlimited seats", "AI battlecards", "24/7 API sync"]'::jsonb, true),
  ('p2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'Pro Tier', 299.00, 'USD', 'monthly', '["Unlimited seats", "24/7 API sync"]'::jsonb, false),
  ('p3333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 'Growth Plan', 149.00, 'USD', 'monthly', '["5 Team Seats", "Custom Reports"]'::jsonb, false)
ON CONFLICT (id) DO NOTHING;
